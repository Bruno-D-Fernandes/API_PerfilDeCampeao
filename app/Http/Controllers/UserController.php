...
class UserController extends Controller
{
    ...
    public function getSeguidores()
    {
        ...
        return response()->json([$usuario->seguidores], 200);
    }
    ...
    public function getSeguindo()
    {
        ...
        $clubes = $usuario->seguindoClubes;
        $usuarios = $usuario->seguindoUsuarios;
    ...
    {
        $usuario = auth()->user();
        return response()->json($usuario->amigos, 200);
    }

    public function getSugestoes()
    {
        $usuario = auth()->user();
        return response()->json($usuario->sugestoes, 200);
    }
