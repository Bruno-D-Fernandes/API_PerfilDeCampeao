            ...
            <div class="h-[37.75rem]">
                <div class="grid grid-cols-20 gap-6">
                    <div class="col-span-6 flex flex-col gap-6">
                        <div class="bg-white p-4 rounded-lg border border-2 border-gray-200 hover:border-sky-500 transition-colors">
                    ...
                    <div class="col-span-8 flex flex-col gap-6">
                        ...
                        <div class="bg-white h-max p-4 rounded-lg border border-2 border-gray-200 hover:border-sky-500 transition-colors flex flex-col gap-3">
                                ...
                                @foreach([1, 2, 3, 4, 5] as $num)
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-x-3">
                                            <div class="h-[1.75rem] border border-l border-3 border-gray-200 hover:border-sky-500 transition-colors rounded-md"></div>
