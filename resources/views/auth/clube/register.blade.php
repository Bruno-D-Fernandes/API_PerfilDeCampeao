    ...
    <x-slot name="left">
        <div class="w-full h-full flex items-center justify-center">
            <x-form-card title="O Futuro Começa Hoje" description="Informe seus dados e acesse o Perfil de Campeão hoje mesmo!  " color="green">
                ...
                <ol class="flex items-center w-full text-sm font-medium text-center text-gray-700 sm:text-base">
                    <li id="crumb-1" class="flex md:w-full items-center sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-default after:border-px after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10">
                        <span class="me-2">
                            <span id="crumb-num-1">1</span>
                        
                            <svg id="crumb-check-1" class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
                        </span>

                        Acesso
                    </li>

                    <li id="crumb-2" class="flex md:w-full items-center sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-default after:border-px after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10">
                        <span class="me-2">
                            <span id="crumb-num-2">2</span>
                        
                            <svg id="crumb-check-2" class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
                        </span>
                    ...
                    <li id="crumb-3" class="flex items-center">
                        <span class="me-2">
                            ...
                            <svg id="crumb-check-3" class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
                        </span>
                ...
                <x-form class="w-full flex flex-col gap-4">
                    ...
                    <div id="step-3" class="hidden form-step flex flex-col gap-4">
                        ...
                        <x-form-group label="Cep" name="nomeClube" type="text" labelColor="green">
                            <x-slot:icon>
                        ...
                        <x-form-group label="Cidade" name="nomeClube" type="text" labelColor="green">
                            <x-slot:icon>
                        ...
                        <x-form-group label="Estado" name="categoria_id" type="select" labelColor="green">
                            <x-slot:icon>
                        ...
                        <x-form-group label="Endereço" name="nomeClube" type="text" labelColor="green">
                            <x-slot:icon>
                        ...
                        <x-checkbox color="green">
                            <x-slot:link>
                                <span class="inline-flex gap-x-1 text-md text-gray-500 font-medium">
                                    Eu concordo com os
                    ...
                    <x-slot:actions>
                        <button type="button" id="btn-prev" onclick="changeStep(-1)" class="hidden cursor-pointer w-full bg-gray-200 text-gray-600 hover:bg-gray-300 font-medium text-lg p-4 rounded-lg transition-transform hover:-translate-y-0.5">
                            Voltar
                        </button>

                        <button type="button" id="btn-next" onclick="changeStep(1)" class="cursor-pointer w-full bg-emerald-500 hover:bg-emerald-600 text-white font-medium text-lg p-4 rounded-lg transition-transform hover:-translate-y-0.5 transition-colors">
                            Avançar
                        </button>

                        <button type="submit" id="btn-submit" class="hidden cursor-pointer w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium text-lg p-4 rounded-lg transition-transform hover:-translate-y-0.5 transition-colors">
                            Finalizar Cadastro
                        </button>
                    </x-slot:actions>
