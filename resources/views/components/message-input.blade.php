<div class="relative w-full group">
    <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
        <svg class="h-5 w-5 text-gray-400 group-focus-within:text-emerald-500 transition-colors" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <input 
        ...
        {{ $attributes->merge(['class' => 'block w-full ps-10 pe-24 py-4 bg-gray-50 border border-gray-200 text-heading text-sm rounded-lg focus:border-emerald-500 transition-colors focus:outline-none placeholder:text-body']) }}
    >
