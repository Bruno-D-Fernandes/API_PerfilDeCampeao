...
<div {{ $attributes->merge(['class' => 'flex items-center justify-between group cursor-pointer hover:bg-gray-50 p-2 -mx-2 rounded-lg transition-colors']) }}>
    <div class="flex gap-3 items-center">
        <div class="flex flex-col items-center justify-center gap-1 w-[3rem] aspect-square rounded-lg border {{ $theme['box'] }}">
            <span class="text-xs font-bold uppercase leading-none mt-0.5">
                {{ $month }}
            </span>
        ...
        <div class="flex flex-col justify-center py-0.5"> 
            ...
            <span class="text-sm font-bold text-gray-800 {{ $theme['hover'] }} transition-colors truncate">
                {{ $title }}
            </span>
