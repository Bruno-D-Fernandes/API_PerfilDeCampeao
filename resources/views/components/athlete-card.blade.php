<a href="" class="flex flex-col gap-4 p-5 bg-white border border-2 border-gray-300/80 hover:border-emerald-400 transition-colors rounded-lg group">
    <div class="relative w-full">
        ...
        <div class="absolute top-0 right-0 z-10 flex gap-x-1">
            ...
            <x-icon-button color="none" class="text-emerald-400 hover:text-emerald-500 transition-colors">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-plus-icon lucide-plus"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
            </x-icon-button>
        </div>
    </div>
    ...
    <div class="flex gap-3 flex-wrap items-center justify-center font-medium">
    ...
    <div class="flex items-center gap-x-2 text-emerald-400 font-medium text-sm">
