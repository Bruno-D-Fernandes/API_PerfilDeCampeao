<div {{ $attributes->merge(['class' => 'cursor-pointer bg-white p-[0.21vw] border-[0.052vw] border-gray-100 relative group hover:bg-gray-50 transition flex flex-col gap-[0.1vw]']) }}>
    <div class="flex justify-between items-start">
        <span class="day-badge transition-colors duration-200 {{ $isToday
            ? 'bg-emerald-500 text-white w-[1.04vw] h-[1.04vw] rounded-[0.25vw] flex items-center justify-center font-semibold text-[0.63vw]' 
