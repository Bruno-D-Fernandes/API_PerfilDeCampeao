...
<div class="group flex flex-col bg-white border border-[0.052vw] border-gray-300 rounded-[0.63vw] hover:border-emerald-500 transition-all duration-200 overflow-hidden relative">
    ...
    <div class="flex flex-row overflow-hidden relative">
        <div class="absolute top-[0.63vw] right-[0.63vw] z-10 opacity-0 group-hover:opacity-100 transition-opacity">
            <div class="flex items-center bg-white rounded-[0.42vw] p-[0.21vw] gap-x-[0.21vw]">
        ...
        <div class="flex-1 p-[0.63vw] flex flex-col justify-between gap-[0.75vw]">
