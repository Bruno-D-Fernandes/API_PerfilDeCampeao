            ...
            <div class="flex flex-col gap-[0.21vw]">
                ...
                <div class="flex flex-col gap-[0.21vw]">
                    <div class="flex items-center gap-[0.42vw] text-[0.63vw] {{ $cardTheme['text_color'] }} leading-tight">
                        <svg class="w-[0.73vw] h-[0.73vw] {{ $cardTheme['icon_color'] }} shrink-0 stroke-[0.1vw]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                ...
                <div class="mt-[0.1vw]">
                    ...
                    @else
                        <a href="{{ route('clube.agenda', ['date' => $dataInicio->format('Y-m-d')]) }}" class="block w-full py-[0.55vw] rounded text-[0.6vw] font-medium text-center {{ $cardTheme['btn_class'] }}">
                            Ver Evento
                        </a>
                    @endif
                </div>
