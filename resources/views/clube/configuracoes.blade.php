<x-layouts.clube title="Configurações" :breadcrumb="[
    ...
    <div class="w-full h-full flex flex-col gap-[0.83vw] border border-2 border-gray-200 rounded-lg p-[0.83vw]">
        <div class="flex flex-col gap-[0.83vw]">
            <span class="text-[0.93vw] text-emerald-700 font-semibold">
                Preferências
            </span>

            <div class="flex flex-col gap-[0.83vw]">
                <div class="flex items-center justify-between cursor-pointer w-full rounded-lg h-[3.75rem] bg-white hover:bg-gray-50 transition-colors p-[0.63vw]">
                    <div class="h-full flex items-center gap-x-[0.42vw]">
                        <div class="h-full aspect-square flex items-center justify-center">
                            <svg class="h-[1.04vw] w-[1.04vw] text-emerald-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bell-icon lucide-bell"><path d="M10.268 21a2 2 0 0 0 3.464 0"/><path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"/></svg>
                        </div>
                    ...
                    <svg class="h-[0.83vw] w-[0.83vw] text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right-icon lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>
                </div>
                ...
                <div class="flex items-center justify-between cursor-pointer w-full rounded-lg h-[3.75rem] bg-white hover:bg-gray-50 transition-colors p-[0.63vw]">
                    ...
                    <div>
                        <label class="inline-flex items-center cursor-pointer">
                            ...
                            <div class="relative p-[0.42vw] w-[1.87vw] h-[1.04vw] bg-gray-100 peer-focus:outline-none peer-focus:ring-brand-soft rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-buffer after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:rounded-full after:h-[0.83vw] after:w-[0.83vw] after:transition-all peer-checked:bg-emerald-500"></div>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="flex flex-col gap-[0.83vw]">
            ...
            <div class="flex flex-col gap-[0.83vw]">
                <div class="flex items-center justify-between cursor-pointer w-full rounded-[0.75vw] h-[3.75rem] bg-white hover:bg-gray-50 transition-colors p-[0.63vw]">
                    <div class="h-full flex items-center gap-x-[0.42vw]">
                        <div class="h-full aspect-square flex items-center justify-center">
