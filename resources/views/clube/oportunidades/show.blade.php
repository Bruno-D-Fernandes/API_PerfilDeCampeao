<x-layouts.clube title="Peneira Sub-17" :breadcrumb="[
    ...
    'Minhas Oportunidades' => route('clube.oportunidades'),
    'Peneira Sub-17' => null
]">
    <div class="flex flex-col gap-6">
        <a href="{{ route('clube.oportunidades') }}" class="flex items-center gap-x-1 text-emerald-500 hover:text-emerald-700 transition-colors font-medium">
        ...
        <div class="relative w-full h-64 rounded-lg bg-gray-300 flex items-center justify-center">
            <button class="absolute bottom-6 right-6 cursor-pointer w-12 h-12 flex items-center justify-center bg-white rounded-full shadow-xs text-gray-600">
                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-camera-icon lucide-camera"><path d="M13.997 4a2 2 0 0 1 1.76 1.05l.486.9A2 2 0 0 0 18.003 7H20a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h1.997a2 2 0 0 0 1.759-1.048l.489-.904A2 2 0 0 1 10.004 4z"/><circle cx="12" cy="13" r="3"/></svg>
            </button>

            <svg class="h-16 w-16 text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-image-icon lucide-image"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>
        </div>
