<x-layouts.clube title="Dashboard" :breadcrumb="[
    ...
    <div class="h-full w-full flex flex-col flex-1">
        <div class="h-[1.67vw] flex gap-x-[0.42vw] items-center w-full mb-[0.83vw]">
            ...
            <div>
                <x-form-group :label="null" name="fe" type="select" id="fe" labelColor="green" class="!h-[1.67vw] pr-[1.67vw] !bg-white leading-none !text-[0.63vw] !border-[0.15vw] !py-0">
                    <x-slot:icon>
                    ...
                    <option class="text-[0.63vw] font-medium text-gray-800 leading-none">
                        Futebol
                    </option>
