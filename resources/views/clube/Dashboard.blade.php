<x-layouts.clube title="Dashboard" :breadcrumb="[
    ...
    <div class="h-full w-full flex flex-col">
        <div class="h-8 flex gap-x-2 items-center pt-2 pb-8 w-full border-b border-gray-300">
            ...
            <div>
                <x-form-group :label="null" name="fe" type="select" id="fe" labelColor="green" class="pr-8 focus:outline-none border border-2 border-gray-200 transition-colors focus:border-emerald-500">
                    <x-slot:icon>
