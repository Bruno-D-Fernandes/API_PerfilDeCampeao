<x-layouts.clube title="Dashboard" :breadcrumb="[
    ...
    <div class="h-full w-full flex flex-col">
        <div class="h-8 flex gap-x-2 items-center pt-2 pb-8 w-full border-b border-gray-300">
            ...
            <div>
                <x-form-group :label="null" name="fe" type="select" id="fe" labelColor="green" class="pr-8 focus:outline-none border border-2 border-gray-200 !bg-white transition-colors focus:border-emerald-500">
                    <x-slot:icon>
                ...
                <div class="grid grid-cols-5 gap-6">
                    <div class="col-span-3 flex flex-col gap-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-white p-4 rounded-lg border border-2 border-gray-200 hover:border-emerald-500 transition-colors">
                    ...
                    <div class="col-span-2 flex flex-col gap-6">
                        <div class="bg-white p-4 rounded-lg border border-2 border-gray-200 hover:border-emerald-500 transition-colors flex flex-col gap-3">
                        ...
                        <div class="bg-white h-max p-4 rounded-lg border border-2 border-gray-200 hover:border-emerald-500 transition-colors flex flex-col gap-3">
                            <div class="flex items-center gap-x-2">
    ...
    <x-toast type="success" dismissable message="Vamos a lá praia" title="Deu certo!"></x-toast>
</x-layouts.clube>